...
class Login(Scene):
    ...
    def draw_widgets(self):
        ...
        self.sign_up_label.bind("<Button-1>", lambda _: self.sign_up_label_pressed())
        self.sign_up_label.bind("<Enter>", lambda _: self.sign_up_label.config(foreground="#00617f"))
        self.sign_up_label.bind("<Leave>", lambda _: self.sign_up_label.config(foreground="#00C2FE"))
        self.sign_up_label.grid(row=6, column=1)
    ...
    def login_button_pressed(self):
        ...
        response = DatabaseAccess().log_in(username, password)
        ...
        self.action_listener.push_action(SceneActions.Login, SceneActions.Login.LOGIN_BUTTON_PRESSED)

    def sign_up_label_pressed(self):
         # notify root window of this action
        self.action_listener.push_action(SceneActions.Login, SceneActions.Login.SIGN_UP_LABEL_PRESSED)
